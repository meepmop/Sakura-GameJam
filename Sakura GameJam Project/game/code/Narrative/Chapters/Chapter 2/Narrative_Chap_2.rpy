label Chapter2:
    ...
    menu beginningForCharacter:
        sb "But, it's kind of funny. That this spot you took us to, also once served as the beginning for said character in the first place."
        "Stay Quiet":
            scene BG YYFront 
    ...
    show ah neutral
    show sb neutral
    ah "As someone that never truly viewed themself as ‘in the norm', I can tell that you and I, [sb], are the same~"
